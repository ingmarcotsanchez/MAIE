<?php
    class Centro extends Conectar{
        public function insert_centro($cen_nombre){

            $conectar = parent::Conexion();
            parent::set_names();
            $sql="INSERT INTO centros (cen_id,cen_nombre, est) VALUES (NULL,?,'1');";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $cen_nombre);
            $sql->execute();

            return $resultado = $sql->fetchAll();
        }

        public function update_centro($cen_id,$cen_nombre){
