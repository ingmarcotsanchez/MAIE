    ...
    switch($_GET["opc"]){
        ...
        case "listar":
                ...
                foreach($datos as $row){
                    ...
                    $sub_array[] = '<button type="button" onClick="editar('.$row["esc_id"].');"  id="'.$row["esc_id"].'" class="btn btn-outline-warning btn-sm ladda-button"><i class="fa fa-edit"></i></button>';
                    $sub_array[] = '<button type="button" onClick="eliminar('.$row["esc_id"].');"  id="'.$row["esc_id"].'" class="btn btn-outline-danger btn-sm ladda-button"><i class="fa fa-trash"></i></button>';
