    ...
    switch($_GET["opc"]){
        ...
        case "listar":
                ...
                foreach($datos as $row){
                    ...
                    $sub_array[] = $row["seme_id"];
                    $sub_array[] = $row["seme_nombre"];
                    $sub_array[] = '<button type="button" onClick="editar('.$row["seme_id"].');"  id="'.$row["seme_id"].'" class="btn btn-outline-warning btn-sm ladda-button"><i class="fa fa-edit"></i></button>';
                    $sub_array[] = '<button type="button" onClick="eliminar('.$row["seme_id"].');"  id="'.$row["seme_id"].'" class="btn btn-outline-danger btn-sm ladda-button"><i class="fa fa-trash"></i></button>';
