    ...
    switch($_GET["opc"]){
        ...
        case "listar":
                ...
                foreach($datos as $row){
                    ...
                    $sub_array[] = '<button type="button" onClick="editar('.$row["asig_id"].');"  id="'.$row["asig_id"].'" class="btn btn-outline-warning btn-sm btn-icon"><i class="fa fa-edit"></i></button>';
                    $sub_array[] = '<button type="button" onClick="eliminar('.$row["asig_id"].');"  id="'.$row["asig_id"].'" class="btn btn-outline-danger btn-sm btn-icon"><i class="fa fa-trash"></i></button>';
