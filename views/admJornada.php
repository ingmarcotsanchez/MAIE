...
<!-- Site wrapper -->
  ...
  <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Admón Jornadas de Estudio</h3>
                </div>
                <div class="card-body">
                    <button type="button" class="btn btn-outline-primary mb-2" onclick="nuevo()">Crear</button>
                    <table id="jornada_data" class="table display responsive wrap">
                        <thead>
                            <tr>
                                <th>Jornada</th>
                                <th>Estado</th>
    ...
    <!-- /.Site warapper -->
    <?php require_once("admJornadaModal.php"); ?>
    <?php include("modulos/js.php"); ?>
    <script type="text/javascript" src="js/admJornada.js"></script>
</body>
</html>
<?php
  }else{
