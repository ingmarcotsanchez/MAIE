...
function init(){
    $("#escalafon_form").on("submit",function(e){
        guardaryeditar(e);
    });
...
function guardaryeditar(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#modalcrearEscalafon').modal('hide');
...
function nuevo(){
    $('#titulo_modal').html('Nuevo Escalafón');
    $('#escalafon_form')[0].reset();
    $('#modalcrearEscalafon').modal('show');
}
...
function editar(esc_id){
    ...
    $('#titulo_modal').html('Editar Escalafón');
    $('#modalcrearEscalafon').modal('show');
}
