...
function guardaryeditar(e){
    ...
    $.ajax({
        url: "/Maie/controller/programas.php?opc=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
        ...
        success: function(data){
            ...
            $('#modalcrearProgramas').modal('hide');
...
$(document).ready(function(){
    $('#cen_id').select2({
        dropdownParent: $('#modalcrearProgramas')
    });
    ...
    $('#programas_data').DataTable({
        ...
        "ajax":{
            url:"/Maie/controller/programas.php?opc=listar",
            type:"post"
        },
        "bDestroy": true,
        "responsive": true,
...
function editar(prog_id){
    $.post("/Maie/controller/programas.php?opc=mostrar",{prog_id:prog_id},function (data){
...
function eliminar(prog_id){
    Swal.fire({
        title: 'Eliminar!',
        text: 'Desea eleminar el Programa?',
        icon: 'error',
        ...
        if(result.value){
            $.post("/Maie/controller/programas.php?opc=eliminar",{prog_id:prog_id},function (data){
                $('#programas_data').DataTable().ajax.reload();
                Swal.fire({
                    title: 'Correcto!',
