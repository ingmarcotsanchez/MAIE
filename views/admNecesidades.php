<?php
$titulo="Necesidad Educativa Especial";
...
<!-- Site wrapper -->
  ...
  <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Admón Necesidad Educativa</h3>
                </div>
                <div class="card-body">
                    <button type="button" class="btn btn-outline-primary mb-2" onclick="nuevo()">Crear</button>
                    <table id="necesidades_data" class="table display responsive wrap">
                        <thead>
                            <tr>
                                <th>Necesidad Educativa Especial</th>
                                <th>Estado</th>
                                <th></th>
                                <th></th>
                            </tr>
    ...
    <!-- /.Site warapper -->
    <?php require_once("admNecesidadesModal.php"); ?>
    <?php include("modulos/js.php"); ?>
    <script type="text/javascript" src="js/admNecesidades.js"></script>
</body>
</html>
<?php
  }else{
