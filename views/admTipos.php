<?php
$titulo="Tipo de Acompañamiento MAIE";
...
<!-- Site wrapper -->
  ...
  <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Admón Tipo de Acompañamiento</h3>
                </div>
                <div class="card-body">
                    <button type="button" class="btn btn-outline-primary mb-2" onclick="nuevo()">Crear</button>
                    <table id="tipaco_data" class="table display responsive wrap">
                        <thead>
                            <tr>
    ...
    <!-- /.Site warapper -->
    <?php require_once("admTiposModal.php"); ?>
    <?php include("modulos/js.php"); ?>
    <script type="text/javascript" src="js/admTipos.js"></script>
</body>
</html>
<?php
  }else{
